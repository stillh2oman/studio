/**
 * PlanPort hub / project shapes (minimal — align with CreateClientDialog payloads).
 * Used by migration tooling and future dual-write; PlanPort app has a mirrored copy.
 */
