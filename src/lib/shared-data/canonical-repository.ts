/**
 * Firestore data-access helpers for canonical shared_clients / shared_projects.
 * Callers pass a Firestore instance (browser or server SDK with compatible API).
 */
...
/** Projects linked to a canonical residential or contractor client id. */
