...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /** When set, dialog renders inside this node (needed for browser native fullscreen, which hides body portaled UI). */
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-wide uppercase",
      className
    )}
    {...props}
  />
