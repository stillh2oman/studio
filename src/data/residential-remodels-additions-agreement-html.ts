 ...
 */
export const RESIDENTIAL_REMODELS_ADDITIONS_AGREEMENT_BODY_HTML = `
<h1>DESIGN SERVICE AGREEMENT (RESIDENTIAL REMODELS / ADDITIONS)</h1>
...
<strong>Residential project location (remodel or addition):</strong> {{projectLocation}}<br/>
<strong>Lead designer (PlanPort record):</strong> {{leadDesignerName}}</p>

<h2>1. SCOPE OF SERVICES</h2>
<p>The Designer shall provide the following Services to the Client relating to the remodel or addition of the residential project located at <strong>{{projectLocation}}</strong>:</p>
<ul>
...
<li><strong>Building Design:</strong> Design services for the residential project layout, addition, or remodel.</li>
...
<li><strong>Construction Documents:</strong> Provision of a plan set to include an as-built floor plan, floor plans, a non-engineered foundation layout, roof plan, electrical plan, exterior elevations, and a non-engineered site plan.</li>
</ul>
...
<li><strong>Plan Review &amp; Acceptance:</strong> All plans will be reviewed by the Client and their General Contractor before materials are ordered or construction begins to ensure they find no issues with the plan set they want to modify or correct. The General Contractor is solely responsible for field-verifying all measurements, dimensions, existing conditions, and local code requirements on-site prior to the start of construction. Once materials are ordered or construction begins, the plans will be considered accepted as is.</li>
</ul>

<h2>3. FEES, PAYMENT, AND COLLECTION</h2>
<ul>
<li><strong>Hourly Rate:</strong> The fees for all services provided under this Agreement will be calculated at a rate of $115.00 per billable hour.</li>
