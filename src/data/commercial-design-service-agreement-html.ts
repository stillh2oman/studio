 ...
 */
export const COMMERCIAL_DESIGN_SERVICE_AGREEMENT_BODY_HTML = `
<h1>DESIGN SERVICE AGREEMENT (COMMERCIAL)</h1>
...
<strong>Project location / site:</strong> {{projectLocation}}<br/>
<strong>Lead designer (PlanPort record):</strong> {{leadDesignerName}}</p>

<h2>1. SCOPE OF SERVICES</h2>
<p>The Designer shall provide the following Services to the Client:</p>
<ul>
<li><strong>Building Design:</strong> Design services for the project layout.</li>
...
<li><strong>Estimates:</strong> All time and fee estimates given are based on the scope of the project presented by the Client to the Designer at the time of the estimate. Any requested changes or issues not presented to the Designer by the Client in the original scope of the project will affect the number of hours needed to complete your project. The Client may request an update on the number of billable hours anytime throughout the design process.</li>
